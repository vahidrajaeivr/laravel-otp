...
return [
    ...
    */
    ...
    /*
     ...
     |
     | Keep in mind, every model must implement "Rajaei\OTP\Contracts\OTPNotifiable" and also
     | use this "Rajaei\OTP\Concerns\HasOTPNotify" trait.
     |
     | You may also change the default repository and replace your own repository. But every repository must
     | implement "Rajaei\OTP\Contracts\NotifiableRepositoryInterface" interface.
     |
     */
    'user_providers'   => [
        'users' => [
